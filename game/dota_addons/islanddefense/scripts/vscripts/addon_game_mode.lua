...
--[[
  ...
  See realId:PostLoadPrecache() in realid.lua for more information
  ]]

  DebugPrint("[REALID] Performing pre-load precache")
...
function Activate()
  GameRules.realId = realId()
  GameRules.realId:_InitrealId()
end
