...
--[[
  ...
  -Ensure that you have the realid_notifications.xml, realid_notifications.js, and realid_notifications.css files in your panorama content folder.
  -Ensure that realid_notifications.xml is included in your custom_ui_manifest.xml with
    <CustomUIElement type="Hud" layoutfile="file://{resources}/layout/custom_game/realid_notifications.xml" />
