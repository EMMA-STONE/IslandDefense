...
--[[
  ...
  -Ensure that you have the realid_attachments.xml, realid_attachments.js, and realid_attachments.css files in your panorama content folder to use the GUI.
  -Ensure that realid_attachments.xml is included in your custom_ui_manifest.xml with
    <CustomUIElement type="Hud" layoutfile="file://{resources}/layout/custom_game/realid_attachments.xml" />
